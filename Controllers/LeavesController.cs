...
namespace RoxCorp.Controllers
{
    public class LeavesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LeaveId,LeaveType")] Leave leave)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LeaveId,LeaveType")] Leave leave)
        {
            if (id != leave.LeaveId)
            {
                return NotFound();
